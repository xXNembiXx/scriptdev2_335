...
void AddSC_custom_events()
{
    ...
    pNewScript->Name = "event_boss_kruul";
    pNewScript->GetAI = &GetAI_event_boss_kruul;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_succubus";
    pNewScript->GetAI = &GetAI_event_npc_succubus;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_hound";
    pNewScript->GetAI = &GetAI_event_npc_hound;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_imp";
    pNewScript->GetAI = &GetAI_event_npc_imp;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_emperor";
    pNewScript->GetAI = &GetAI_event_npc_emperor;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_fel_reaver";
    pNewScript->GetAI = &GetAI_event_npc_fel_reaver;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_image_kruul";
    pNewScript->GetAI = &GetAI_event_npc_image_kruul;
    pNewScript->pGossipHello = &GossipHello_event_npc_image_kruul;
    pNewScript->pGossipSelect = &GossipSelect_event_npc_image_kruul;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_boss_murky";
    pNewScript->GetAI = &GetAI_event_boss_murky;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_boss_gurky";
    pNewScript->GetAI = &GetAI_event_boss_gurky;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_follow_one";
    pNewScript->GetAI = &GetAI_event_npc_follow_one;
    pNewScript->pQuestAccept = &QuestAccept_event_npc_follow_one;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_follow_two";
    pNewScript->GetAI = &GetAI_event_npc_follow_two;
    pNewScript->pQuestAccept = &QuestAccept_event_npc_follow_two;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "event_npc_follow_three";
    pNewScript->pGossipHello = &GossipHello_event_npc_follow_three;
    pNewScript->pGossipSelect = &GossipSelect_event_npc_follow_three;
    pNewScript->RegisterSelf();
}
